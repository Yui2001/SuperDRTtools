...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.show_peak_comp = QtWidgets.QPushButton(self.show_layout)
        self.show_peak_comp.setGeometry(QtCore.QRect(980, 10, 127, 28))
        self.show_peak_comp.setObjectName("show_peak_comp")
        self.show_peak_comp.hide()
        ...
        self.KK_frame.setGeometry(QtCore.QRect(10, 750, 281, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.run_layout.setGeometry(QtCore.QRect(10, 590, 281, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.Peak_analysis_frame.setGeometry(QtCore.QRect(10, 910, 281, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.peak_method_choice.addItem("")
        self.peak_count_choice = QtWidgets.QComboBox(self.Peak_analysis_frame)
        self.peak_count_choice.setGeometry(QtCore.QRect(170, 50, 81, 21))
        self.peak_count_choice.setObjectName("peak_count_choice")
        self.peak_count_choice.addItem("Auto")
        for peak_count in range(1, 13):
            self.peak_count_choice.addItem(str(peak_count))
        self.peak_num_entry.hide()
        self.peak_all_button = QtWidgets.QPushButton(self.Peak_analysis_frame)
        self.peak_all_button.setGeometry(QtCore.QRect(140, 100, 111, 21))
        self.peak_all_button.setObjectName("peak_all_button")

        self.peak_results_frame = QtWidgets.QGroupBox(self.General_frame)
        self.peak_results_frame.setGeometry(QtCore.QRect(10, 1070, 281, 241))
        self.peak_results_frame.setObjectName("peak_results_frame")
        self.peak_results_table = QtWidgets.QTableWidget(self.peak_results_frame)
        self.peak_results_table.setGeometry(QtCore.QRect(10, 25, 261, 205))
        self.peak_results_table.setObjectName("peak_results_table")
        self.peak_results_table.setColumnCount(6)
        self.peak_results_table.setHorizontalHeaderLabels(
            ["Peak", "τ / s", "f / Hz", "R / Ω", "%", "FWHM / dec"]
        )
        # Use ASCII unit labels here so generated UI source remains portable
        # across Windows code pages. Plot labels retain mathematical symbols.
        self.peak_results_table.setHorizontalHeaderLabels(
            ["Peak", "tau / s", "f / Hz", "R / ohm", "%", "FWHM / dec"]
        )
        self.peak_results_frame.hide()
        self.export_frame = QtWidgets.QGroupBox(self.General_frame)
        self.export_frame.setGeometry(QtCore.QRect(10, 1030, 281, 141))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.export_peak_label = QtWidgets.QLabel(self.export_frame)
        self.export_peak_label.setGeometry(QtCore.QRect(10, 90, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.export_peak_label.setFont(font)
        self.export_peak_label.setObjectName("export_peak_label")
        self.export_fig_label = QtWidgets.QLabel(self.export_frame)
        self.export_fig_label.setGeometry(QtCore.QRect(10, 120, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.export_peak_button = QtWidgets.QPushButton(self.export_frame)
        self.export_peak_button.setGeometry(QtCore.QRect(170, 80, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.export_peak_button.setFont(font)
        self.export_peak_button.setObjectName("export_peak_button")
        self.export_fig_button = QtWidgets.QPushButton(self.export_frame)
        self.export_fig_button.setGeometry(QtCore.QRect(170, 110, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        # --- Project panel ---
        self.project_frame = QtWidgets.QGroupBox(self.General_frame)
        self.project_frame.setGeometry(QtCore.QRect(10, 1180, 281, 151))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.project_frame.setFont(font)
        self.project_frame.setStyleSheet("")
        self.project_frame.setObjectName("project_frame")
        self.open_project_button = QtWidgets.QPushButton(self.project_frame)
        self.open_project_button.setGeometry(QtCore.QRect(170, 20, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.open_project_button.setFont(font)
        self.open_project_button.setObjectName("open_project_button")
        self.save_project_button = QtWidgets.QPushButton(self.project_frame)
        self.save_project_button.setGeometry(QtCore.QRect(170, 50, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.save_project_button.setFont(font)
        self.save_project_button.setObjectName("save_project_button")
        self.save_project_as_button = QtWidgets.QPushButton(self.project_frame)
        self.save_project_as_button.setGeometry(QtCore.QRect(170, 80, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.save_project_as_button.setFont(font)
        self.save_project_as_button.setObjectName("save_project_as_button")
        self.open_project_label = QtWidgets.QLabel(self.project_frame)
        self.open_project_label.setGeometry(QtCore.QRect(10, 30, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.open_project_label.setFont(font)
        self.open_project_label.setObjectName("open_project_label")
        self.save_project_label = QtWidgets.QLabel(self.project_frame)
        self.save_project_label.setGeometry(QtCore.QRect(10, 60, 101, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.save_project_label.setFont(font)
        self.save_project_label.setObjectName("save_project_label")
        self.save_project_as_label = QtWidgets.QLabel(self.project_frame)
        self.save_project_as_label.setGeometry(QtCore.QRect(10, 90, 121, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.save_project_as_label.setFont(font)
        self.save_project_as_label.setObjectName("save_project_as_label")
        self.new_window_button = QtWidgets.QPushButton(self.project_frame)
        self.new_window_button.setGeometry(QtCore.QRect(170, 80, 81, 21))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.new_window_button.setFont(font)
        self.new_window_button.setObjectName("new_window_button")
        self.new_window_label = QtWidgets.QLabel(self.project_frame)
        self.new_window_label.setGeometry(QtCore.QRect(10, 90, 121, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        self.new_window_label.setFont(font)
        self.new_window_label.setObjectName("new_window_label")
        self.save_project_as_button.hide()
        self.save_project_as_label.hide()
    ...
    def _apply_responsive_shell(self):
        ...
        for gb in [self.settings_layout, self.RBF_frame, self.KK_frame, self.run_layout, self.Peak_analysis_frame,
                   self.export_frame, self.project_frame]:
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.show_KK_res.setText(_translate("MainWindow", "Lin-KK Residual"))
        ...
        self.show_peak_comp.setText(_translate("MainWindow", "Peak Comparison"))
        ...
        self.KK_frame.setTitle(_translate("MainWindow", "Lin-KK"))
        ...
        self.peak_decon_button.setText(_translate("MainWindow", "Peak One"))
        self.peak_all_button.setText(_translate("MainWindow", "Peak All"))
        self.reg_param_2.setText(_translate("MainWindow", "Peak count"))
        ...
        self.peak_results_frame.setTitle(_translate("MainWindow", "Peak Results"))
        self.export_frame.setTitle(_translate("MainWindow", "Export Result"))
        self.export_DRT_label.setText(_translate("MainWindow", "DRT"))
        self.export_EIS_label.setText(_translate("MainWindow", "EIS"))
        self.export_peak_label.setText(_translate("MainWindow", "Peak"))
        ...
        self.export_peak_button.setText(_translate("MainWindow", "Export"))
        self.export_fig_button.setText(_translate("MainWindow", "Save"))
        self.project_frame.setTitle(_translate("MainWindow", "Project"))
        self.open_project_label.setText(_translate("MainWindow", "Open Project"))
        self.save_project_label.setText(_translate("MainWindow", "Save Project"))
        self.open_project_button.setText(_translate("MainWindow", "Open"))
        self.save_project_button.setText(_translate("MainWindow", "Save"))
        self.new_window_label.setText(_translate("MainWindow", "New Window"))
        self.new_window_button.setText(_translate("MainWindow", "Open"))
